...
function App() {
  ...
  return <main ref={appRef}>
    ...
    <section id="membership" className="membership section-pad"><div className="membership-inner"><div><div className="section-kicker">/05 — Jadi bagian dari kami</div><h2>Temukan ruang<br /><span>untuk tumbuh.</span></h2></div><div className="membership-copy"><p>Gabung menjadi anggota Kagama Digi dan ikut membangun jejaring, wawasan, serta inovasi digital bersama alumni UGM dan pegiat digital dari berbagai bidang.</p><button className="membership-cta" onClick={() => setShowRegister(true)}>Daftar jadi member <Arrow /></button></div></div><div className="membership-footer"><span>Terbuka untuk alumni UGM</span><span>Digital · Inovasi · Kolaborasi</span></div></section>
